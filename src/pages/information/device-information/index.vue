  ...
  <div class="dyeing-order">
    ...
    >
      <t-form ref="formRef" :data="formData" :rules="rules" label-align="top" >
        <t-form-item label="设备号" name="name">
          <t-input v-model="formData.name" placeholder="请输入内容" />
        </t-form-item>
        <t-form-item label="设备ID" name="password">
        ...
        <t-form-item label="工段" name="password">
          <t-input v-model="formData.password" clearable />
        </t-form-item>
        <t-form-item label="工序" name="password">
          <t-input v-model="formData.password" clearable />
        </t-form-item>
      </t-form>
      <template #footer>
        <t-button v-show="drawer == `编辑设备`" theme="primary" type="submit" @click="onSubmit">保存</t-button>
        <t-button v-show="drawer == `新增设备`" theme="primary" type="submit" @click="onSubmit">保存并新增</t-button>
        <t-button v-show="drawer == `新增设备`" theme="primary" type="submit" @click="onSubmit">保存并复制</t-button>
