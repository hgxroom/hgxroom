...
<template>
  <div class="dyeing-order">
    ...
    >
      ...
      <template #footer>
        <t-button v-show="drawer == `编辑工序`" theme="primary" type="submit" @click="onSubmit">保存</t-button>
        <t-button v-show="drawer == `新增工序`" theme="primary" type="submit" @click="onSubmit">保存并新增</t-button>
        <t-button v-show="drawer == `新增工序`" theme="primary" type="submit" @click="onSubmit">保存并复制</t-button>
